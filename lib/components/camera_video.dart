...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  Widget _cameraPreviewWidget() {
    ...
    if (cameraController == null || !cameraController.value.isInitialized) {
      ...
      return Listener(
        ...
        //onPointerCancel: (_) => stopVideoRecording(),
      );
    }
  }
  ...
  void onSetFlashModeButtonPressed(FlashMode mode) {
    setFlashMode(mode).then((_) {
      ...
      showInSnackBar('Flash mode set to ${mode
          .toString()
          .split('.')
          .last}');
    });
  ...
  void onSetExposureModeButtonPressed(ExposureMode mode) {
    setExposureMode(mode).then((_) {
      ...
      showInSnackBar('Exposure mode set to ${mode
          .toString()
          .split('.')
          .last}');
    });
  ...
  void onSetFocusModeButtonPressed(FocusMode mode) {
    setFocusMode(mode).then((_) {
      ...
      showInSnackBar('Focus mode set to ${mode
          .toString()
          .split('.')
          .last}');
    });
  ...
  volver(int tipo) async {
    print('VOLVER   >>>>>>>>>>>>>>>>>>>>>>   ASDASDASD');
    onNewCameraSelected(controller!.description);
  ...
  Future<void> _initCamera(CameraDescription description) async {
    controller =
        CameraController(description, ResolutionPreset.medium, enableAudio: true);
